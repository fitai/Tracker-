...
//******fitai_variables******                 
//tripple blink for hardware faliure::::Double blink for connection faliur ||||| yellow blink with 300ms gap == mqtt data connection problem
// 
//
...

{
  ...
  packetHeader0 =              "{\"header\": {\"collar_id\": ";                     // id change 
